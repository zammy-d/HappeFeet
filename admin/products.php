   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
        ...
        <div class="inputBox">
         ...
         <div class="inputBox">
            <span>observaciones del producto (obligatorio)</span>
            <textarea name="details" placeholder="observaciones del producto  " class="box" required maxlength="500" cols="30" rows="10"></textarea>
         </div>
      </div>
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="dettalles"><span><?= $fetch_products['details']; ?></span></div>
      <div class="flex-btn">
